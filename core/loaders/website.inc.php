...
if (!defined("SHARED_RESOURCE_URL")) {
	...
	if (!defined("SHARED_RESOURCE_URI"))
...
// Request Queries
if (!function_exists("runkit_function_redefine") || !runkit_function_redefine("array_key_exists", '$array, $key', 'return isset($array[$key]);')) {
