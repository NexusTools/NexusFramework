...
class UPSShippingProvider extends ShippingProvider {
	...
	public static function init(){
		...
		if(self::$settings->isValidString("shipper-id") &&
			self::$settings->isValidString("access-key") &&
			self::$settings->isValidString("username") &&
			self::$settings->isValidString("password"))
...
<AccessRequest xml:lang='en-US'>
  <AccessLicenseNumber>" . self::$settings->getValue("access-key") . "</AccessLicenseNumber>
  <UserId>" . self::$settings->getValue("username") . "</UserId>
  <Password>" . self::$settings->getValue("password") . "</Password>
</AccessRequest>
";
	}
...
<RatingServiceSelectionRequest>
  ...
  <Shipment>
    ...
    <Shipper>
      <ShipperNumber>" . self::$settings->getValue("shipper-id") . "</ShipperNumber>
      <Address>
