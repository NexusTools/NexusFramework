...
Tracking Code<br />
<input class="text large" value="<? echo htmlspecialchars($settings->getValue("code")); ?>" name="code" /><br />
Default Domain <help title="When tracking multiple top level domains, set this to the default domain">?</help><br />
<input value="<? echo htmlspecialchars($settings->getValue("domain")); ?>" class="text" style="width: 350px" name="domain" /></form>
