...
class PageCategories {
	...
	public static function checkStatusRecursively($catid){
		...
		return self::checkStatusRecursively(self::$database->selectField("categories", Array("rowid" => $catid), "parent"))
			&& eval("return " . self::$database->selectField("categories", Array("rowid" => $catid), "condition") . ";");
	}
